...
Out of the box, this approach automatically renders a prebuilt checkout page that lets you start accepting online payments immediately. The checkout page is fully customizable to match your specific needs ([see customization documentation](https://docs.rebill.com/sdk/checkout#display) for more details).
